...
class Content(object):
	...
	def __init__(self, parent, title, text_separator, font_format, font_size):
	...
	def get_xml(self):
		...
		return """<w:sdtContent>
            <w:p w14:paraId="2E84F3E4" w14:textId="09293AD7" w:rsidR="00D7315D" w:rsidRDefault="00D7315D">
              <w:pPr>
...
class PageNumber(object):
	...
	def __init__(self, parent, title='', text_separator='/', font_format='b', font_size=10):
		self.name = 'sdt'
		self.parent = parent
		self.tab = parent.tab
		self.separator = parent.separator
		...
		self.content = Content(self, title, text_separator, font_format, font_size)
